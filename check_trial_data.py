...
trials = json.load(open('production_data/trial_records.json', encoding='utf-8'))
...
results = json.load(open('results_continuous.json', encoding='utf-8'))
...
if 'scores' in module_4_results:
    ...
    if has_bonus_fields:
        ...
        if progress_unique == 1 and enrollment_unique == 1:
            print("\n   ⚠️  PROBLEM: All bonuses are identical!")
